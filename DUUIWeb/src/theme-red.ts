...
export const ThemeRed: CustomThemeConfig = {
	name: 'theme-red',
	properties: {
		// =~= Theme Properties =~=
		...
		// =~= Theme Colors  =~=
		// primary | #f87060
		'--color-primary-50': '254 234 231', // #feeae7
		'--color-primary-100': '254 226 223', // #fee2df
		'--color-primary-200': '253 219 215', // #fddbd7
		'--color-primary-300': '252 198 191', // #fcc6bf
		'--color-primary-400': '250 155 144', // #fa9b90
		'--color-primary-500': '248 112 96', // #f87060
		'--color-primary-600': '223 101 86', // #df6556
		'--color-primary-700': '186 84 72', // #ba5448
		'--color-primary-800': '149 67 58', // #95433a
		'--color-primary-900': '122 55 47', // #7a372f
		// secondary | #00bcff
