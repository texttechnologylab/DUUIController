...
export type IOProvider = 'Dropbox' | 'Minio' | 'File' | 'Text' | 'NextCloud' | 'None'
...
export const IO_INPUT: string[] = ['Dropbox', 'File', 'Minio', 'Text', 'NextCloud']
export const INPUT_EXTENSIONS: string[] = ['.txt', '.xmi', '.gz']

export const IO_OUTPUT: string[] = ['Dropbox', 'Minio', 'NextCloud', 'None']
