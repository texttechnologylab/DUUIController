...
export const ThemeGreen: CustomThemeConfig = {
	name: 'theme-green',
	properties: {
		// =~= Theme Properties =~=
		...
		// =~= Theme Colors  =~=
		// primary | #44d268
		'--color-primary-50': '227 248 232', // #e3f8e8
		'--color-primary-100': '218 246 225', // #daf6e1
		'--color-primary-200': '208 244 217', // #d0f4d9
		'--color-primary-300': '180 237 195', // #b4edc3
		'--color-primary-400': '124 224 149', // #7ce095
		'--color-primary-500': '68 210 104', // #44d268
		'--color-primary-600': '61 189 94', // #3dbd5e
		'--color-primary-700': '51 158 78', // #339e4e
		'--color-primary-800': '41 126 62', // #297e3e
		'--color-primary-900': '33 103 51', // #216733
		// secondary | #00bcff
