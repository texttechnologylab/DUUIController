...
public class StanfordPos {
    public static void main(String[] args) throws Exception {
        ...
        HttpServer server = HttpServer.create(new InetSocketAddress("127.0.0.1", 9002), 0);

        server.getAddress();
        server.createContext("/v1/communication_layer", new StanfordPos.CommunicationLayer());
